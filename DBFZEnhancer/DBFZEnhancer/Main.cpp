...
const ULONG DLC_OFFSET = 0x6D0310; 	//48 89 5C 24 08 55 56 57 48 8B EC 48 83 EC ? 48 8B F9
const ULONG PAK_OFFSET = 0x3468060; //Found in 48 89 5C 24 18 55 56 57 41 54 41 55 48 8D 6C 24 C9 48 81 EC ? ? ? ? 48 8B FA - L:75
